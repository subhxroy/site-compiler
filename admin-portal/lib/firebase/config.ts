...
if (firebaseConfig.apiKey) {
  try {
    ...
    console.warn('[Admin Portal Firebase] Auth initialization skipped:', (err as Error)?.message || err);
  }
} else {
  console.warn('[Admin Portal Firebase] NEXT_PUBLIC_FIREBASE_API_KEY is missing. Auth is disabled for local dev.');
}
